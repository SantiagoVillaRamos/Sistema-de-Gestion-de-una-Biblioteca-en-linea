...
from application.dto.book_command_dto import CreateBookCommand, CreateBookResponse, UpdateBookDTOCommand
...
class FacadeBook:
    ...
    async def create_book(self, command: CreateBookCommand) -> CreateBookResponse:
